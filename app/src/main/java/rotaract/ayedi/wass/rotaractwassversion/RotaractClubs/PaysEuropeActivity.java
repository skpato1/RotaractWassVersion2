...
public class PaysEuropeActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pays_europe);
        ListView mListView;
...

        {
            ...
            final ArrayAdapter<String> adapter = new ArrayAdapter<String>(PaysEuropeActivity.this,
